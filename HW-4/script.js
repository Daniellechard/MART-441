...
function Game() {
  document.getElementById("text").innerHTML = "You find yourself in the port city of Elleron, you have a few days before your boat heads out to the Elvish Isle.";
var local = prompt("Where do you want to go?\nInn, Port, or Market?");
if (local === "Inn"){
  document.getElementById("text").innerHTML = "The local Inn is called the Horse's Head. Its not the most beautiful place but it's pleasant in its own smelly way.";
}
  else if (local === "Port"){
    document.getElementById("text").innerHTML = "The Port is busy, filled wih immigrants straight off the boat, and merchants peddling whatever goods they have. It smells like fish and Hobbits, but the view is nice.";
  }
  else{
    document.getElementById("text").innerHTML = "The market is loud and busy, full of stalls with almost anything you can imagine.";
  }
